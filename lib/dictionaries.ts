...
const en: CommonDictionary = {
    ...
    productCard: {
        ...
        view_details: "Study This Pair",
        currently_unavailable: "At the Workbench",
        usd: "USD",
    },
    cart: {
...
const mn: CommonDictionary = {
    navigation: {
        shop: "Урлан",
        heritage: "Өв Соёл",
        atelier: "Бидний Тухай",
        cart: "Сагс",
        search_placeholder: "Бүтээл хайх...",
        shop_now: "Урланд зочлох",
        shop_collection: "Бүтээлүүдийг үзэх",
        our_heritage: "Бидний түүх",
        visit_atelier: "Урланд зочлох",
        shopping_bag: "Таны сагс",
        language: "Хэл",
    ...
    productCard: {
        ...
        currently_unavailable: "Урлагдаж байна",
        usd: "ам.доллар",
    },
    cart: {
        your_cart: "Таны сагс",
        empty_cart_title: "Урлан таныг хүлээж байна",
        empty_cart_description: "Таны цуглуулга хараахан эхлээгүй байна. Тохирох хосыг олоход тэр мэдэгдэх болно.",
        browse_collection: "Урланд зочлох",
        size: "Хэмжээ",
        remove: "Чөлөөлөх",
        subtotal: "Нийлбэр",
        shipping: "Хүргэлт",
        ...
        discount: "Хөнгөлөлт",
        total: "Нийт",
        checkout: "Захиалгаа баталгаажуулах",
        continue_shopping: "Цуглуулга руу буцах",
    ...
    footer: {
        brand_description: "1990 оноос Улаанбаатар хотод гараар урласан. Тал нутгийн тэвчээр урлангийн нарийн урлалтай уулздаг газар.",
        brand_quote: "Зарим зүйлийг яарах боломжгүй.",
        shop_title: "Урлан",
        all_collection: "Бүх бүтээл",
        ceremonial: "Ёслолын",
        festival: "Баярын",
        ...
        newsletter_title: "Итгэлт Хүрээлэлд Нэгдэх",
        newsletter_description: "Зөвхөн чанар, үнэ цэнийг эрхэмлэдэг эрхмүүдэд зориулав. Шинэ бүтээл, урлангийн түүх, цор ганц загваруудын мэдээллийг түрүүлж хүргэнэ. Спам илгээхгүй.",
