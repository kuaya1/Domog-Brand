            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-24">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="font-sans text-cream-200 text-sm leading-relaxed mb-4 max-w-xs">
                            {t.brand_description}
                        </p>
                        <p className="font-serif text-gold-500 text-sm italic mb-6 max-w-xs">
                    ...
                    <div>
                        ...
                        <div className="mt-8 pt-6 border-t border-cream/10">
                            <p className="font-sans text-xs text-cream-200/70 uppercase tracking-wider mb-2">
                                {t.hours_label}
                            </p>
                ...
                <div className="mt-16 pt-12 border-t border-cream/10">
                    <div className="max-w-xl">
                        ...
                        <p className="font-sans text-cream-200/60 text-xs mt-3">
                            {t.newsletter_note}
                        </p>
                    </div>
                </div>
            ...
            <div className="border-t border-cream/10">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className="font-sans text-xs text-cream-200/70">
                            © {currentYear} {t.copyright}
                        </p>
                        <div className="flex items-center gap-6">
                            <Link 
                                href={localizedPath('/privacy')} 
                                className="font-sans text-xs text-cream-200/70 hover:text-gold transition-colors duration-300"
                            >
                                {t.privacy_policy}
                            </Link>
                            <Link 
