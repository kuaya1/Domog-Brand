        ...
        <div className="bg-white">
            ...
            <section className="relative min-h-screen flex items-center justify-center bg-stone-50">
                <div className="max-w-4xl mx-auto px-6 lg:px-8 py-32 text-center">
                    <p className="font-sans text-xs uppercase tracking-[0.3em] text-amber-800/70 mb-8">
                        A Manifesto
                    </p>
                    <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-stone-900 font-normal leading-tight mb-12">
                        Between the Steppe and the Piazza
                    </h1>
                    <div className="w-16 h-px bg-amber-700/40 mx-auto" />
                </div>
            </section>
            ...
            <section className="py-24 lg:py-32 bg-white">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                    <div className="prose prose-lg prose-stone mx-auto">
                        <p className="text-xl lg:text-2xl text-stone-700 leading-relaxed font-serif italic">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <div className="order-2 lg:order-1">
                            <p className="font-sans text-xs uppercase tracking-[0.25em] text-amber-700 mb-6">
                                I. Nomadic Strength
                            </p>
                        ...
                        <div className="order-1 lg:order-2 relative h-[500px] bg-stone-200 rounded-sm overflow-hidden">
            ...
            <section className="py-24 lg:py-32 bg-white">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <div className="relative h-[500px] bg-stone-200 rounded-sm overflow-hidden">
                            <div className="absolute inset-0 flex items-center justify-center text-stone-400 font-serif italic">
                                The Atelier
                            </div>
                        </div>
            ...
            <section className="py-32 lg:py-40 bg-stone-900 text-white relative overflow-hidden">
                <div className="absolute inset-0 opacity-10">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_transparent_0%,_rgba(0,0,0,0.8)_100%)]" />
                </div>
                <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        <p className="font-sans text-xs uppercase tracking-[0.3em] text-amber-500 mb-6">
                    ...
                    <div className="space-y-8 text-stone-300 text-lg lg:text-xl leading-relaxed text-center max-w-2xl mx-auto">
                        <p>
                        ...
                        <p className="text-white font-serif italic text-2xl lg:text-3xl py-8">
                    ...
                    <div className="mt-20 relative h-80 lg:h-96 bg-stone-800 rounded-sm overflow-hidden">
                        <div className="absolute inset-0 flex items-center justify-center text-stone-500 font-serif italic">
            ...
            <section className="py-24 lg:py-32 bg-stone-50">
                <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
                    <p className="font-sans text-xs uppercase tracking-[0.25em] text-amber-700 mb-8">
                        Our Promise
                    </p>
                    ...
                    <div className="mt-16 pt-16 border-t border-stone-200">
                        <p className="font-serif text-2xl text-stone-800 italic">
                            Domog
                        </p>
            ...
            <section className="py-24 lg:py-32 bg-white">
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
                    <p className="font-sans text-xs uppercase tracking-[0.25em] text-amber-700 mb-12">
